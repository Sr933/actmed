...
def get_experiment_config(model_name, seed):
    ...
    return {
        ...
        "hepatitis": {
            ...
            "model_class": HepatitisEntropyBEDModel,
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        ...
        print("experiment_type: 'kidney', 'diabetes', 'hepatitis', 'heart', or 'cirrhosis'")
        print("model_name: Name of the model to use (e.g., 'gpt-4.1-mini')")
