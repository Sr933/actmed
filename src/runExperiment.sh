...
run_experiment() {
    ...
    local model_name=$2
    local seed=$3
    screen -dmS "${experiment_type}_${model_name}_${seed}" bash -c "source $CONDA_PATH && conda activate actmed && python /home/sr933/BayesianReasoning/src/Experiment.py $experiment_type $model_name $seed; exec bash"
}
